...
// Hook'u component içinde çağırıyoruz
  ...
  return (
    <>
      <section className="flex flex-column items-center justify-start h-screen text-center gap-[20px] bg-[var(--kirmizi)] text-[var(--beyaz)] font-[Barlow] order-success-section">
        ...
        {orderData && (
          <div className="items-center flex flex-column gap-[20px] order-success-message">
            <p className="font-[Satisfy] font-[400] text-[32px] leading-[44.27px] tracking-[0] text-center align-middle text-[var(--sari)]">lezzetin yolda</p>
            ...
            <hr className="!border !border-[var(--bej)] w-100" />
            ...
            <div className="flex flex-column px-[49px] py-[46px] !border !border-[var(--bej)] rounded-[6px] w-[350px] h-[197px] text-[var(--beyaz)] total-price">
              <h4 className="text-[var(--beyaz)] font-[600] font-[Barlow] !text-[20px] !leading-[24.76px] !tracking-[0] align-middle text-left">Sipariş Toplamı</h4>
              <div className="flex justify-between option-prices">
                <span className="text-[var(--beyaz)] font-[Barlow] text-[18px] leading-[24.76px] tracking-[0]">Seçimler</span>
                <span className="text-[var(--beyaz)]  font-[Barlow] text-[18px] leading-[24.76px] tracking-[0]">{ingredients.length*5*pieceCount}₺</span>
              </div>
              <div className="flex justify-between sum-price">
                <span className="text-[var(--beyaz)] font-[Barlow] text-[18px] leading-[24.76px] tracking-[0]">Toplam</span>
                <span className="text-[var(--beyaz)] font-[Barlow] text-[18px] leading-[24.76px] tracking-[0]">{totalPrice}₺</span>
              </div>
            </div>
          </div>
        )}
